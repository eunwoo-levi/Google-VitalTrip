      ...
      resources: {
        en: {
          common: {
            ...
            'firstaid.reported_symptoms': 'Symptoms you described',
            'firstaid.emergency_numbers': 'Emergency Numbers',
            'firstaid.tip_112':
              'Tip: In many countries, dialing 112 connects you to all emergency services.',
            'firstaid.police': 'Police',
            'firstaid.ambulance': 'Ambulance',
            'firstaid.fire': 'Fire',
            'firstaid.emergency': 'Emergency',
            'firstaid.call': 'Call',
            'firstaid.situation_summary': 'Situation Summary',
            'firstaid.protocol_title': 'Emergency First Aid Protocol',
            'firstaid.protocol_subtitle': 'Follow these steps carefully and in order',
            'firstaid.recommended_title': 'Recommended Next Steps',
            'firstaid.recommended_subtitle': 'Important actions to take immediately',
            'firstaid.resources_title': 'Additional Medical Resources',
            'firstaid.resources_subtitle': 'Trusted sources for more information',
            'firstaid.disclaimer_title': 'Safety Notice',
            'firstaid.resource_label': 'Medical Resource',
            ...
            'medical.no_facilities_found': 'No {{type}}s found nearby',
            'medical.try_increase_radius': 'Try increasing the search radius or check another area',
            'medical.facilities_found': '{{count}} {{type}}{{plural}} found',
            'medical.within_radius': 'Within {{radius}}km radius',
        ...
        ko: {
          common: {
            ...
            'firstaid.reported_symptoms': '설명하신 증상',
            'firstaid.emergency_numbers': '응급 번호',
            'firstaid.tip_112': 'Tip: 많은 국가에서 112는 모든 응급 서비스와 연결됩니다.',
            'firstaid.police': '경찰',
            'firstaid.ambulance': '구급차',
            'firstaid.fire': '소방',
            'firstaid.emergency': '응급',
            'firstaid.call': '전화',
            'firstaid.situation_summary': '상황 요약',
            'firstaid.protocol_title': '응급처치 절차',
            'firstaid.protocol_subtitle': '아래 순서를 주의 깊게 따라주세요',
            'firstaid.recommended_title': '권장 조치',
            'firstaid.recommended_subtitle': '즉시 수행해야 하는 중요한 행동',
            'firstaid.resources_title': '추가 의학 자료',
            'firstaid.resources_subtitle': '신뢰할 수 있는 참고 자료',
            'firstaid.disclaimer_title': '주의 사항',
            'firstaid.resource_label': '의학 자료',
            ...
            close: '닫기',
            'medical.title': '의료 시설',
            'medical.subtitle': '근처의 의료 서비스를 찾아보세요',
            'medical.facility_type': '시설 유형',
            'medical.search_radius': '검색 반경',
            'medical.searching': '근처 시설을 검색 중',
            'medical.please_wait': '잠시만 기다려 주세요...',
            'medical.something_wrong': '문제가 발생했습니다',
            'medical.try_again': '나중에 다시 시도해 주세요',
            'medical.no_facilities_found': '근처에 {{type}}이(가) 없습니다',
            'medical.try_increase_radius': '검색 반경을 늘리거나 다른 지역을 확인해 보세요',
            'medical.facilities_found': '{{count}}개의 {{type}}을 찾았습니다',
            'medical.within_radius': '반경 {{radius}}km 내',
            'medical.open_now': '영업 중',
            'medical.closed': '영업 종료',
            'medical.visit_website': '웹사이트 방문',
            'medical.types.hospital': '병원',
            'medical.types.pharmacy': '약국',
            'medical.types.emergency': '응급실',
          },
          symptoms: {
